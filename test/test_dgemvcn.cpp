...
int main() {
	...
	struct {
		...
		{"Naive", cblas_dgemvCN_naive, false, false},
		{"UnrollI2", cblas_dgemvCN_unrollinner2, false, false},
		//		{"UnrollI2Pre", cblas_dgemvCN_unr2_prefetch, false, false},
		//		{"UnrollI4", cblas_dgemvCN_unrollinner4, false, false},
		{"UnrollI8", cblas_dgemvCN_unrollinner8, false, false},
		{"BlockC4", cblas_dgemvCN_strideC4, false, false},
		{"BlockC8", cblas_dgemvCN_strideC8, false, false},
		{"SSE", cblas_dgemvCN_sseinner, true, true},
		{"SSE2", cblas_dgemvCN_sseinner2, true, true},
		{"SSE_incx1", cblas_dgemvCN_sseinner_incx1, true, false},
		{"SSE2_incx1", cblas_dgemvCN_sseinner2_incx1, true, false},
		{"SSE4_incx1", cblas_dgemvCN_sseinner2_incx1, true, false},
		{"Block32", cblas_dgemvCN_block32, false, false},
		{"Block64", cblas_dgemvCN_block64, false, false},
		{"Block64", cblas_dgemvCN_block64_v2, false, false},
		{"Block128", cblas_dgemvCN_block128, false, false},
		{"Block256", cblas_dgemvCN_block256, false, false},
		{"Block512", cblas_dgemvCN_block256, false, false}};
	struct {
		const char* name;
		size_t incx, incy;
